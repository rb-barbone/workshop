export default {
  ...
  "task.empty": "Nessun task",
  "task.confirmDelete.title": "Confermi eliminazione?",
  "task.confirmDelete.description": "Questa azione non può essere annullata.",
  "task.confirm": "Conferma",
  "task.cancel": "Annulla",
  "task.toast.created": "Task creato",
  "task.toast.create_error": "Errore nella creazione del task",
  "task.toast.updated": "Task aggiornato",
  "task.toast.update_error": "Errore nell'aggiornamento del task",
  "task.toast.deleted": "Task eliminato",
  "task.toast.delete_error": "Errore nell'eliminazione del task",
} as const;
