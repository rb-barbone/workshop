export default {
  ...
  "task.empty": "No tasks",
  "task.confirmDelete.title": "Confirm deletion?",
  "task.confirmDelete.description": "This action cannot be undone.",
  "task.confirm": "Confirm",
  "task.cancel": "Cancel",
  "task.toast.created": "Task created",
  "task.toast.create_error": "Failed to create task",
